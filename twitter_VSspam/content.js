(function () {
  ...
  const observer = new MutationObserver((mutations) => {
    mutations.forEach((mutation) => {
      if (document.getElementById('hiddenButton').textContent == "フォロー中非表示") {
        let boxes = document.getElementsByClassName('css-175oi2r r-1mmae3n r-3pj75a r-1loqt21 r-o7ynqc r-6416eg r-1ny4l3l');
        let TFchecks = document.getElementsByClassName('css-175oi2r r-sdzlij r-1phboty r-rs99b7 r-lrvibr r-15ysp7h r-4wgw6l r-3pj75a r-1loqt21 r-o7ynqc r-6416eg r-1ny4l3l');
